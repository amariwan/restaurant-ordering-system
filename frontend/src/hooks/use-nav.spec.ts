...
describe('useFilteredNavItems', () => {
  ...
  it('shows matching role routes after hydration', () => {
    ...
    const { result, rerender: _rerender } = renderHook(() => useFilteredNavItems(baseItems));
