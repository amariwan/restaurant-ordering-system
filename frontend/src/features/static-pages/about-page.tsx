...
export default function AboutPage() {
  ...
  return (
    <div className='mx-auto max-w-3xl space-y-8'>
      ...
      <section className='bg-card rounded-2xl border p-8 shadow-sm'>
        <h2 className='text-foreground mb-4 text-xl font-semibold'>{t.staticAbout.realtimeTitle}</h2>
        <p className='text-muted-foreground text-lg leading-relaxed'>
      ...
      <section className='bg-card rounded-2xl border p-8 shadow-sm'>
        <h2 className='text-foreground mb-4 text-xl font-semibold'>{t.staticAbout.integrationTitle}</h2>
        <p className='text-muted-foreground text-lg leading-relaxed'>
