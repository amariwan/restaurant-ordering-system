...
export default function ReservationsPage() {
  ...
  return (
    <PageContainer pageTitle="Reservations" pageDescription="Manage table reservations." pageHeaderAction={<ReservationFormSheetTrigger />}>
      <div className="mb-6 flex items-center gap-3">
        <select value={status} onChange={(e) => setStatus(e.target.value)} className="w-40 rounded-md border border-input bg-transparent px-3 py-2 text-sm outline-none focus:border-ring focus:ring-2 focus:ring-ring/50">
